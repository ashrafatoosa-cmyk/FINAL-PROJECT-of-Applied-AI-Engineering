    ...
    <div className="min-h-screen bg-brand-900 text-white font-sans overflow-y-auto pb-24 selection:bg-accent-500">
      ...
      <div className="p-4 sm:p-6 space-y-6 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className={`p-4 rounded-2xl border transition-colors ${(latestData && (latestData.engine_temp ?? 0) > 100) ? 'bg-red-500/20 border-red-500/50' : 'bg-white/5 border-white/10'}`}>
          ...
          <div className={`p-4 rounded-2xl border transition-colors ${(latestData && (latestData.vibration_hz ?? 0) > 40) ? 'bg-red-500/20 border-red-500/50' : 'bg-white/5 border-white/10'}`}>
            <div className="flex items-center gap-2 text-white/50 mb-2">
              <Activity size={14} />
